...
class ClienteForm(forms.ModelForm):
    ...
    def clean_cedula_pasaporte(self):
        data = self.cleaned_data['cedula_pasaporte'].upper().strip()  # Normalizar a mayúsculas
        if not data.replace('-', '').isalnum():  # Permitir guiones
            raise ValidationError("Solo se permiten números, letras y guiones")
            return data
    ...
    def clean(self):
        ...
        # Validar que al menos un contacto está presente
